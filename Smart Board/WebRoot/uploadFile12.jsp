...
<div style="position: absolute; width: 669px; height: 37px; z-index: 2; left:130px; top:324px" id="layer2">
        ...
        <%
           ...
           // String appPath = application.getRealPath("/");  
            java.io.File file1 = new File("C:\\Files1");
      ...
      %>
        ...
        rs=st.executeQuery("select SAVEDFILEPATH from fileupload1 where cname='"+cname+"'");
        if(rs.next()){}
        else{
        pst = con.prepareStatement("insert into fileupload values(?,?,?,to_date(sysdate))");
        pst.setString(1,cid);
