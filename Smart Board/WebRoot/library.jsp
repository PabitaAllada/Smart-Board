...
<html>
    ...
    <body> <jsp:include page="index.jsp"></jsp:include>   
            <div style="position: absolute; width: 792px; height: 425px; z-index: 3; left: 115px; top: 229px" id="layer6">
                ...
                <div style="position: absolute; width: 283px; height: 55px; z-index: 1; left: 257px; top: 28px" id="layer1">
                    <p align="center"><b>
    ...
    <div style="position: absolute; width: 300px; height: 63px; z-index: 4; left: 390px; top: 316px" id="layer9">
