...
<html>
    ...
    <body>
        ...
        con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","se","seproj");
            ...
            rs1=st1.executeQuery("select cid from college where uname='"+cname+"'");  
            if(rs1.next())
                   cid=rs1.getString(1);   
        st=con.createStatement();
        pst = con.prepareStatement("insert into request values(?,?,?,?,?,to_date(sysdate),?,?,?)");
        pst.setString(1,cid);
