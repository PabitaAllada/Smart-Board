    ...
    <body>
        ...
        <form action="sendResponse1.jsp" method="post">
            <div style="position: absolute; width: 792px; height: 425px; z-index: 3; left: 115px; top: 229px" id="layer6">
                ...
                rs1=st1.executeQuery("select * from request where response='No Response' ");  
                if(rs1.next())
                {
                ...
                reqdate=rs1.getString(6);
                 %>
                        <tr>
                            <td width="114"><b>
                            <font face="Verdana" size="2" color="#E4DB6B">Name</font></b></td>
                            <td colspan="2"><b>
							<font face="Verdana" size="2" color="#FFFFFF"><%=stname%></font></b></td>
                        </tr>
                        <tr>
                            <td width="114"><b>
                            ...
                            <td colspan="2"><b>
							<font face="Verdana" size="2" color="#FFFFFF"><%=reqfor%></font></b></td>
                        </tr>
                        <tr>
                            <td width="114"><b>
                                    <font face="Verdana" size="2" color="#E4DB6B">
                            ...
                            <td colspan="2"><b>
							<font face="Verdana" size="2" color="#FFFFFF"><%=reqdate%></font></b></td>
                        </tr>
                        <tr>
                            <td width="114"><b>
                                    <font face="Verdana" size="2" color="#E4DB6B">
